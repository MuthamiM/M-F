...
import { ArrowLeft, Handshake, Lightbulb, Users2, ArrowRight } from "lucide-react";
      ...
      <section className="w-full px-4 py-16 sm:px-8 lg:px-12 sm:py-24 space-y-16">
        ...
        <div className="rounded-xl bg-[#1B222C] text-white p-8 sm:p-10 text-center space-y-4 max-w-3xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-[#9AA5B1] leading-relaxed max-w-xl mx-auto">
            Email us directly at <span className="font-mono text-white font-semibold">partnerships@mftechnologies.co</span> or send an inquiry via our contact channel. Let&apos;s build financial infrastructure together.
          </p>
          <div className="pt-2">
            <Link
              href="/contact"
